...
async function main() {
    ...
    const tokensAllotment = [ethers.utils.parseEther("250000"), ethers.utils.parseEther("500000"), ethers.utils.parseEther("200000"), ethers.utils.parseEther("550000"), ethers.utils.parseEther("1500000")]
    ...
    const Distribution = await hre.ethers.getContractFactory("SeedDistribution");
    ...
    await tokenEth.connect(tokenOwner).transfer(distribution.address, ethers.utils.parseEther("3000000"))
