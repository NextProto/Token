...
async function main() {
    ...
    const tokensAllotment = [ethers.utils.parseEther("5000000"), ethers.utils.parseEther("4000000"), ethers.utils.parseEther("1000000"), ethers.utils.parseEther("2000000"), ethers.utils.parseEther("3000000")]
    ...
    const Distribution = await hre.ethers.getContractFactory("TeamDistribution");
    ...
    await tokenEth.connect(tokenOwner).transfer(distribution.address, ethers.utils.parseEther("15000000"))
