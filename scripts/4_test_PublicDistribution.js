...
async function main() {
    ...
    const tokensAllotment = [ethers.utils.parseEther("1000000"), ethers.utils.parseEther("400000"), ethers.utils.parseEther("100000"), ethers.utils.parseEther("200000"), ethers.utils.parseEther("300000")]
    ...
    const Distribution = await hre.ethers.getContractFactory("PublicDistribution");
    ...
    await tokenEth.connect(tokenOwner).transfer(distribution.address, ethers.utils.parseEther("2000000"))
